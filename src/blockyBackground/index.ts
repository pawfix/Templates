function createBackgroundBlocks(blockContainer:HTMLDivElement):void {
...
(window as any).globalCreateBlock = function (blockContainer:HTMLDivElement) {
    createBackgroundBlocks(blockContainer);
}
